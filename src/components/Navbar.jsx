...
const Navbar = () => {
  ...
  // Cierra el menú automáticamente al cambiar a desktop/tablet
  // y oculta el icono en desktop
  // Se usa window.matchMedia para detectar el tamaño
  // y se actualiza el estado cuando cambia
  // Solo muestra el icono y el menú en <1024px
  ...
  // y cerrar el menú si se pasa a desktop
  // También actualiza isMobile
  useEffect(() => {
    const handleResize = () => {
  ...
  return (
    <>
      {/* Icono y menú móvil solo en mobile/tablet */}
      {isMobile && (
        <>
      ...
      {/* Sidebar vertical fija en desktop */}
      {!isMobile && (
          ...
          <div className="sidebar-container">
            ...
            <ul className="sidebar-menu">
              ...
              <motion.li
                ...
                transition={{ duration: 0.5, delay: 0.2 }}
              >
                <Link to="/experience" className={`sidebar-link ${isActive('/experience')}`}>
                  <span className="nav-line"></span>
                  <span className="nav-text">Experiencia</span>
                </Link>
              </motion.li>
